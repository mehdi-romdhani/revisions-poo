...
class Product
{
    ...
    public function getCategory(){
        ...
        $stmt->bindValue(':id', $this->id_category);
        $stmt->execute();
        $result = $stmt->fetch(PDO::FETCH_ASSOC);
        $newCategory = new Category($result['id'],$result['name'],$result['description'], new DateTime($result['createdAt']), new DateTime($result['updatedAt']));
        return $newCategory;
